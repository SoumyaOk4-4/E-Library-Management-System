...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/edit-book.css">
    ...
    <div class="form-container">
        ...
        <form action="${pageContext.request.contextPath}/books/edit/${book.id}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="number" id="quantity" name="quantity" required min="0" value="${book.quantity}">
            </div>
